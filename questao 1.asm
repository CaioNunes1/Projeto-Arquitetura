...
main:
    ...
    la $a1, str1
    jal strcpy
    # Agora, buffer cont�m uma c�pia de str1
    ...
    li $a2, 13
    jal memcpy
    # Agora, os primeiros 13 bytes de buffer cont�m uma c�pia de str2

    # Teste a fun��o strcmp
    la $a0, str1
    la $a1, str2
    jal strcmp
...
next_char:
    beqz $t0, end_strcmp  # Se $t0 � zero (NULL), entao termina
    addiu $a0, $a0, 1    
    addiu $a1, $a1, 11
